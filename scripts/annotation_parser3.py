...
## Annotation parser to filter out antelopes from AP10-k dataset

# INPUTS
exclude_species = ["antelope"]
...
output_folder_path = os.path.join(curr_dir_path, "filtered_ap10k_no_antelopes", "data")
...
output_filepath = os.path.join(curr_dir_path, "filtered_ap10k_no_antelopes", "annotations", output_filename)
